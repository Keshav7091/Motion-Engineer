...
const TrustedBy = () => {
  ...
  return (
    <section className="pt-24 bg-black-theme-rich">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16 opacity-100 transform-none">
          ...
          <h3 className="text-3xl md:text-4xl font-bold font-montserrat mb-6 tracking-tight text-white-theme-pure">
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="bg-white rounded-xl p-8 md:p-10 shadow-md opacity-100">
              <div className="text-center mb-12">
                <h2 className="text-2xl md:text-3xl font-bold text-black font-montserrat mb-2">
